...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(6,5){\includegraphics[scale=0.735]{cover}}} % Image background

\centering
~\vfill
\begin{textblock}{5}(5.7,15)
{\Large{\textbf{Ver. 1.0.3\\2015-12-06}}}
\end{textblock}
\endgroup
...
\noindent{\Large 渡邊　裕太 ( Yuuta Watanabe )}\\
\noindent\rule{7cm}{1pt}\\
\normalsize
2015年九州大学工学部電気情報工学科卒業．現在九州大学大学院システム情報科学府在学中．環境情報構造化の研究に従事.\\
